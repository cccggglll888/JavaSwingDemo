package com.cgl.swing.jtable.d0532;
...
public class SortableTableModelAbstractTableModel extends JFrame {
	DefaultTableModel model = new DefaultTableModel(new Object[][] {
			{ "this", "1" }, { "text", "2" }, { "will", "3" }, { "be", "4" },
			{ "sorted", "5" } }, new Object[] { "Column 1", "Column 2" });
...
class SampleSortingTableModel extends AbstractTableModel implements
		TableModelListener {
