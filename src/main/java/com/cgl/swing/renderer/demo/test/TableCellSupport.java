 ...
 * @param <T>
 */
public abstract class TableCellSupport<T> implements TableCellEditor, TableCellRenderer {
	...
	private ArrayList<WeakReference<CellEditorListener>> listeners = new ArrayList<WeakReference<CellEditorListener>>();
	...
	public Component getTableCellEditorComponent(JTable table, Object value,
		...
		((Component) component).setForeground(FOREGROUND);
	...
	public void addCellEditorListener(CellEditorListener l) {
		listeners.add(new WeakReference<CellEditorListener>(l));
	}

	// 删除CellEditorListener
	public void removeCellEditorListener(CellEditorListener l) {
		listeners.remove(new WeakReference<CellEditorListener>(l));
	}
	...
	public Component getTableCellRendererComponent(JTable table, Object value,
		...
		((Component) component).setFont(table.getFont());
		if (isSelected) {
			((Component) component).setBackground(SELECTION_BACKGROUND);
			((Component) component).setForeground(SELECTION_FOREGROUND);
		} else {
			((Component) component).setBackground(BACKGROUND);
			((Component) component).setForeground(FOREGROUND);
		}
	...
	protected void fireEditingStopped() {
		...
		for (WeakReference<CellEditorListener> ref : listeners) {
